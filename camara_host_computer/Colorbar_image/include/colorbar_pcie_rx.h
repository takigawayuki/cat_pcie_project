...
#define COLORBAR_DMA_MAX_BYTES (COLORBAR_FRAME_SIZE + COLORBAR_MARK_SIZE)
#define COLORBAR_BUFFER_COUNT 1u
#define COLORBAR_PAGE_SIZE 4096u
#define COLORBAR_BUFFER_SIZE (((COLORBAR_DMA_MAX_BYTES + COLORBAR_PAGE_SIZE - 1u) / COLORBAR_PAGE_SIZE) * COLORBAR_PAGE_SIZE)
