...
performance the_instance_name (
  ...
  .txn(txn),                                                // output [3:0]
  .txp(txp),                                                // output [3:0]
  .pcs_nearend_loop(pcs_nearend_loop),                      // input [3:0]
  .pma_nearend_ploop(pma_nearend_ploop),                    // input [3:0]
  .pma_nearend_sloop(pma_nearend_sloop),                    // input [3:0]
